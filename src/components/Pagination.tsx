function Pagination() {
    return (
        <div className="flex flex-row w-full justify-center items-center gap-3 py-10">
            <button className="flex justify-center hover:cursor-pointer items-center box-border px-3 py-2 bg-[#19201E] text-[#8F9996] rounded-md">Назад</button>
            ...
            <button className="flex justify-center hover:cursor-pointer items-center box-border px-3 py-2 bg-[#19201E] text-[#8F9996] rounded-md">Вперёд</button>
        </div>
    )
}
